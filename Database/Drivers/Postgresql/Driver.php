 ...
 * 
 * This package provides access to Postgresql Database system using PDO
 */
class Driver implements DriverInterface, DriverQueryBuilder
{
    ...
    {
        // connect now
        return self::connectWithDefaultPDO($config, 'pgsql');
    }
        ...
        if ($source == '') :
            ...
            if (is_array($drivers)) :
                ...
                foreach ($drivers as $driver => $value) :
                    ...
                    if (strtolower($driver) == 'postgresql' && $value != null) $source = $value;

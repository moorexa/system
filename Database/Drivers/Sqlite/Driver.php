 ...
 * 
 * This package provides access to SQLITE Database system using PDO
 */
class Driver implements DriverInterface, DriverQueryBuilder
{
    ...
    {
        // connect now
        return self::connectWithDefaultPDO($config, 'sqlite');
    }
        ...
        if ($source == '') :
            ...
            if (is_array($drivers)) :
                ...
                foreach ($drivers as $driver => $value) :
                    ...
                    if (strtolower($driver) == 'sqlite' && $value != null) $source = $value;

...
/**
 * @package Mssql driver
 * @author Amadi ifeanyi <amadiify.com>
 * @author Fregatelab <fregatelab.com>
 * 
 * This package provides access to MSSQL Database system using PDO
 */
class Driver implements DriverInterface, DriverQueryBuilder
{
    ...
    {
        // connect now
        return self::connectWithDefaultPDO($config, 'sqlsrv');
    }
        ...
        if ($source == '') :
            ...
            if (is_array($drivers)) :
                ...
                foreach ($drivers as $driver => $value) :
                    ...
                    if (strtolower($driver) == 'mssql' && $value != null) $source = $value;
